...
void main()
{
	...
	//2) ??????ѕолучаем IP-адреса, на которых можно запусть сокет:
	//2) ѕровер€ем, не зан€т ли порт
	addrinfo hints;
	...
	//3) —оздаем сокет, который будет прослушивать сервер:
	...
	//4) —в€зываем сокет с сетевой картой, которую он будет прослушивать:
	...
	//6) «ацикливаем сокет на получение соединений от клиентов
